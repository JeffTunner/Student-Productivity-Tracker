...
export async function mockRespond({ systemPrompt, messages, tools }) {
  ...
  if (violatesGuardrails(user)) {
    return "Sorry — I can’t help with that. I can assist with planning, study, journaling, and your tasks instead.";
  }
  ...
  switch (intent) {
    ...
    default:
      return `Got it. Do you want me to use today's mood/journal/tasks to help? Try: "summarize today".`;
  }
}
