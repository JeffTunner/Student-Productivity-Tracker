...
function Signup() {
    ...
    return (
        ...
        <div className="flex flex-col justify-center shadow-md rounded-2xl p-8 mb-5 bg-slate-100 w-96  md:shadow-lg">
            ...
            <form onSubmit={(e) => {e.preventDefault(); alert("You have successfully Signed Up!!!"); console.log({username, email, password, confirmPassword});}}>
                ...
                <div className="flex justify-center mb-4">
                    <button className="w-full transition-shadow duration-200 text-slate-50 bg-green-500 px-3 py-2 text-xl font-semibold rounded-md hover:bg-green-400 hover:shadow-md" type="submit">Signup</button>
                </div>
